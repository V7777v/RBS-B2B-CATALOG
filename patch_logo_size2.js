...
const t1 = `                {/* 4. Clickable RBS Logo / Home Button */}
                <button 
                  ...
                  className="flex items-center justify-center h-12 w-16 bg-white hover:bg-gray-100 border border-gray-200 rounded-lg shadow-sm transition-all duration-200 active:scale-90 flex-shrink-0"
                  aria-label="דף הבית"
                  title="דף הבית - RBS"
                >
                  <img 
...
const t2 = `              {/* Breadcrumb style path indicator with inline breadcrumbs on desktop */}
              <div className="hidden md:flex items-center text-sm text-[#0c2d57] opacity-85 whitespace-nowrap gap-2">
                <img 
                  ...
                  src="/new-logo.png" 
                  alt="RBS Logo" 
                  className="h-14 w-14 object-contain cursor-pointer hover:opacity-80 active:scale-95 transition-all" 
                  onClick={() => {`;
